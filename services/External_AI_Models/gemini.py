...
۴. **پیش‌بینی آینده:** یک پیش‌بینی کوتاه و آینده‌نگر در مورد احساسات حاکم بر بازار و مسیر احتمالی دارایی‌های کلیدی در ۲۴ تا ۴۸ ساعت آینده ارائه بده.
۵. درتحلیل خودت میتونی از دیتا اخباری که بهت دادم هم استفاده کنی
۶. ** خروجی خودت رو به صورت کد Markdown بهم بده
